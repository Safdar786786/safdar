...
----------------------------------------------
 Author    : Safdar ali
 Github    : KING110
 Facebook  : MR.KING.Sweets
 Tool Name : KING-PRO
 Type type : Free
 Version   : 1.9.9
----------------------------------------------
 KING Pro version 1.9.9
 For Haters: Humhare Pakistan 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923478672013&text="
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: safdar, ali, farman, Ashan\033[1;97m')
                linex()
